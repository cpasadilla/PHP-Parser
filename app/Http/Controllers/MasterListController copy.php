    ...
    public function list(Request $request) {
        ...
        $orders = Order::with([
            'parcels' => function($query) {
                $query->select('id', 'orderId', 'itemId', 'itemName', 'quantity', 'unit', 'desc');
            },
        ...
        $itemCategories = $allParcels->unique('itemName')->mapWithKeys(function($parcel) {
            $pricelist = PriceList::where('item_code', $parcel->itemId)->first();
            return [$parcel->itemName => $pricelist ? $pricelist->category : ''];
        });
        $filterData['itemCategories'] = $itemCategories;
        $filterData['uniqueCategories'] = $itemCategories->values()->unique()->sort()->values();
