...
@php
$isActiveClasses =  $isActive ? 'text-white bg-emerald-500 shadow-lg hover:bg-emerald-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
