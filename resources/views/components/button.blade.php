...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-emerald-500 text-white hover:bg-emerald-600 focus:ring-emerald-500';
        break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-500 hover:bg-gray-100 focus:ring-emerald-500 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
