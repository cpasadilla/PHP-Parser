<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
            {{ __('Monthly Cash Receipt Journal - Shipping') }}
        </h2>
    </x-slot>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="text-2xl font-bold mb-4">Monthly Cash Receipt Journal - Shipping</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        ...
                        <div class="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-orange-800 dark:text-orange-200">Shipping Receipts</h3>
                            <div class="mt-2 text-2xl font-bold text-orange-600 dark:text-orange-400">₱0.00</div>
                        </div>
                        
                        <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-purple-800 dark:text-purple-200">Container Receipts</h3>
