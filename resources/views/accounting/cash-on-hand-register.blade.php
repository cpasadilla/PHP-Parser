        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="text-2xl font-bold mb-4">Cash on Hand Register</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        ...
                        <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-green-800 dark:text-green-200">Current Cash Balance</h3>
                            <div class="mt-2 text-2xl font-bold text-green-600 dark:text-green-400">₱0.00</div>
                        </div>
                        
                        <div class="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-yellow-800 dark:text-yellow-200">Total Cash In</h3>
                            <div class="mt-2 text-2xl font-bold text-yellow-600 dark:text-yellow-400">₱0.00</div>
                        </div>
                        
                        <div class="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-red-800 dark:text-red-200">Total Cash Out</h3>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg mb-6">
                        <h3 class="text-lg font-semibold mb-4">Cash Position Summary</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="text-center p-4 bg-white dark:bg-gray-600 rounded-lg">
                                <div class="text-sm text-gray-600 dark:text-gray-400">Opening Balance</div>
                                <div class="text-xl font-bold text-blue-600 dark:text-blue-400">₱0.00</div>
                            </div>
                            <div class="text-center p-4 bg-white dark:bg-gray-600 rounded-lg">
                                <div class="text-sm text-gray-600 dark:text-gray-400">Net Movement</div>
                                <div class="text-xl font-bold text-orange-600 dark:text-orange-400">₱0.00</div>
                            </div>
                            <div class="text-center p-4 bg-white dark:bg-gray-600 rounded-lg">
                                <div class="text-sm text-gray-600 dark:text-gray-400">Closing Balance</div>
                                <div class="text-xl font-bold text-green-600 dark:text-green-400">₱0.00</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Add Cash Entry Form -->
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg mb-6">
                        <h3 class="text-lg font-semibold mb-4">Add Cash Entry</h3>
                        <form class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Cash transaction description" class="w-full px-3 py-2 border border-gray-300 rounded-md dark:border-gray-600 dark:bg-gray-700" />
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Cash In</th>
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Cash Out</th>
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Running Balance</th>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                        No cash entries found. Start by adding a new entry above.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
