<x-app-layout>
    ...
    <div class="p-6 bg-white rounded-md shadow-md dark:bg-dark-eval-1 w-full overflow-hidden">
        <h1 class="text-lg font-bold text-center md:text-left">MASTER LIST FOR M/V SAVER STAR VOYAGE {{ $voyageNum }}</h1>
        <br>
...
<script>
    ...
    document.getElementById('exportExcel').addEventListener('click', function () {
        ...
        XLSX.writeFile(workbook, 'MASTER LIST - SAVER STAR VOY {{ $voyageNum }}.xlsx');
    });
</script>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.getElementById('exportPdf').addEventListener('click', function () {
            ...
            // Save the PDF
            doc.save('MASTER LIST - SAVER STAR VOY {{ $voyageNum }}.pdf');
        });
    });
</script>
<script>
