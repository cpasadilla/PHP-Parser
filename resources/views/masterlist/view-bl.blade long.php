<x-app-layout>
    ...
    <div class="p-6 bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        ...
        <!-- For pushOrder -->
        <div id="printContainer" class="border p-6 shadow-lg text-black bg-white">
            <div>
            ...
            <table class="w-full text-sm text-center" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <!-- Main Table -->
                <table class="w-full border-collapse text-sm main-table" style="padding: 0 5px; margin-top: 20px; page-break-inside: auto;">
                    ...
                    <tbody style="page-break-inside: auto;">
                        ...
                        <tr class="border-gray" style="border-bottom: 1px solid #cccccc; page-break-inside: avoid;">
            ...
            <footer style="margin-top: 20px; page-break-inside: avoid;">
