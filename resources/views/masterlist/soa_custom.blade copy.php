<x-app-layout>
        ...
        <div id="printContainer" class="border p-6 shadow-lg text-black bg-white print-container" style="font-family: Arial, sans-serif;" data-ship="{{ $ship }}" data-voyage="{{ htmlspecialchars_decode($voyage, ENT_QUOTES) }}">
            <div class="main-content">
                <div style="display: flex; align-items: flex-start; gap: 0; margin-bottom: 0; border: 1px solid #000; padding: 10px;">
                    ...
                    <div style="flex: 1 1 auto; line-height: 1.1; text-align: center; margin-right: 40px;">
                        <p style="margin: 0; font-size: 23px; font-weight: bold; color: green;">ST. FRANCIS XAVIER STAR SHIPPING LINES, INC.</p>
                        <p style="margin: 0; font-size: 17px;">National Road Brgy. Kaychanarianan, Basco Batanes</p>
                        <p style="margin: 0; font-size: 17px;"> Vat Reg. TIN: 009-081-111-000 CP No: 0999-889-5851    Email Add: fxavier_2015@yahoo.com.ph</p>
                        <p style="margin: 0; margin-bottom: 0; padding: 0; line-height: 1; font-size: 20px; color: blue; text-decoration: underline;">STATEMENT OF ACCOUNT</p>
                    </div>
                </div>
                <div style="display: flex; justify-content: flex-end; margin: 0; border: 1px solid #000; border-top: none; line-height: 0; text-align: right; background-color: #e6f7e6;">
                    <p style="margin-bottom: 0; line-height: 1; text-align: right;"><strong>SOA NO.:</strong> 
    ...
    <script>
        ...
        function printContent(divId) {
            ...
            // Clone the print container to measure ONLY the main content (landscape)
            var tempContainer = printContainer.cloneNode(true);
            tempContainer.style.position = 'absolute';
            tempContainer.style.visibility = 'hidden';
            tempContainer.style.width = '297mm'; // A4 width in landscape
            ...
            // Calculate if main content + signature fits on one page (landscape)
            // A4 height in landscape (short edge) minus margins = 210mm - 25.4mm ≈ 184.6mm ≈ ~700px
