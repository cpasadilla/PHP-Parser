                    ...
                    <tr>
                        ...
                        <th>
                            <div class="flex flex-col gap-1">
                                ...
                                <select class="filter-dropdown" data-column="category">
                                    <option value="">All Categories</option>
                                    @foreach(($filterData['uniqueCategories'] ?? []) as $category)
...
<script>
    const itemCategories = @json($filterData['itemCategories'] ?? []);
</script>
                        ...
                        if (descCell) {
                            ...
                            spans.forEach(span => {
                                ...
                                if (parts.length >= 2) {
                                    ...
                                    const cat = itemCategories[itemName];
                                    if (cat && cat.toLowerCase() === activeFilters[column]) {
                                        hasCategory = true;
                                    }
                                }
                            });
