                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="hire_date_display" id="hire_date" value="{{ old('hire_date', $crew->hire_date ? $crew->hire_date->format('m/d/Y') : '') }}" 
                                    ...
                                    <input type="hidden" name="hire_date" id="hire_date_hidden">
                                    @error('hire_date')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="contract_expiry_display" id="contract_expiry" 
                                           value="{{ old('contract_expiry', $crew->contract_expiry ? $crew->contract_expiry->format('m/d/Y') : '') }}" 
                                           placeholder="MM/DD/YYYY"
                                           pattern="\d{2}/\d{2}/\d{4}"
                                           class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                    <input type="hidden" name="contract_expiry" id="contract_expiry_hidden">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="seaman_book_issue_date_display" id="seaman_book_issue_date" 
                                               value="{{ old('seaman_book_issue_date', $crew->seaman_book_issue_date ? $crew->seaman_book_issue_date->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="seaman_book_issue_date" id="seaman_book_issue_date_hidden">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="seaman_book_expiry_date_display" id="seaman_book_expiry_date" 
                                               value="{{ old('seaman_book_expiry_date', $crew->seaman_book_expiry_date ? $crew->seaman_book_expiry_date->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="seaman_book_expiry_date" id="seaman_book_expiry_date_hidden">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="medical_certificate_issue_date_display" id="medical_certificate_issue_date" 
                                               value="{{ old('medical_certificate_issue_date', $crew->medical_certificate_issue_date ? $crew->medical_certificate_issue_date->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="medical_certificate_issue_date" id="medical_certificate_issue_date_hidden">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="medical_certificate_display" id="medical_certificate" 
                                               value="{{ old('medical_certificate', $crew->medical_certificate ? $crew->medical_certificate->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="medical_certificate" id="medical_certificate_hidden">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="dcoc_issue_date_display" id="dcoc_issue_date" 
                                               value="{{ old('dcoc_issue_date', $crew->dcoc_issue_date ? $crew->dcoc_issue_date->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="dcoc_issue_date" id="dcoc_issue_date_hidden">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="dcoc_expiry_display" id="dcoc_expiry" 
                                               value="{{ old('dcoc_expiry', $crew->dcoc_expiry ? $crew->dcoc_expiry->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="dcoc_expiry" id="dcoc_expiry_hidden">
                                        @error('dcoc_expiry')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="marina_license_issue_date_display" id="marina_license_issue_date" 
                                               value="{{ old('marina_license_issue_date', $crew->marina_license_issue_date ? $crew->marina_license_issue_date->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="marina_license_issue_date" id="marina_license_issue_date_hidden">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="marina_license_expiry_display" id="marina_license_expiry" 
                                               value="{{ old('marina_license_expiry', $crew->marina_license_expiry ? $crew->marina_license_expiry->format('m/d/Y') : '') }}" 
                                               placeholder="MM/DD/YYYY"
                                               pattern="\d{2}/\d{2}/\d{4}"
                                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white date-input">
                                        <input type="hidden" name="marina_license_expiry" id="marina_license_expiry_hidden">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            dateInputs.forEach(input => {
                ...
                // Initialize hidden fields for existing values
