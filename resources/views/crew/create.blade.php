<x-app-layout>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="birthday_display" id="birthday" value="{{ old('birthday') ? \Carbon\Carbon::parse(old('birthday'))->format('m/d/Y') : '' }}" 
                            ...
                            <div class="mt-6">
                                ...
                                <textarea name="address" id="address" rows="3" 
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="division" id="division" 
                                        ...
                                        <option value="ship_crew" {{ old('division') == 'ship_crew' ? 'selected' : '' }}>Ship Crew</option>
                                        <option value="office_staff" {{ old('division') == 'office_staff' ? 'selected' : '' }}>Office Staff</option>
                                        <option value="operations" {{ old('division') == 'operations' ? 'selected' : '' }}>Operations</option>
                                        <option value="apprentice" {{ old('division') == 'apprentice' ? 'selected' : '' }}>Apprentice</option>
                                    </select>
                                    @error('division')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select name="department" id="department" 
                                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white" disabled>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="dcoc_number" id="dcoc_number" value="{{ old('dcoc_number') }}" 
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="marina_license_number" id="marina_license_number" value="{{ old('marina_license_number') }}" 
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            divisionSelect.addEventListener('change', function() {
                ...
                if (selectedDivision && departmentMapping[selectedDivision]) {
                    ...
                    departmentMapping[selectedDivision].forEach(function(dept) {
                        ...
                        // Check if this was the old selected value (for form validation errors)
                        if ('{{ old("department") }}' === dept.value) {
            ...
            // Trigger change event on page load if division is already selected (for form validation errors)
